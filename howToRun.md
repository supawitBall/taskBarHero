...
2. ไม่มี item → `"ไม่พบ item ในกระเป๋า Hero"` แล้วหยุด
3. เช็กสี **Stash ช่องสุดท้าย** — ตรงสีว่าง = มีที่, ไม่ตรง = เต็ม
4. Stash เต็ม → เปลี่ยน tab ถัดไป (1 → 2 → 3)
5. Stash tab 3 เต็ม → `" ===== Item เต็มระบบหยุดทำงาน ===== "`
6. Right-click ย้าย item ทีละชิ้น
